...
int main(int, char **) {
  ...
  SDL_Window *window = SDL_CreateWindow(
      MyApp::config.window_title, SDL_WINDOWPOS_CENTERED,
      SDL_WINDOWPOS_CENTERED, MyApp::config.width, MyApp::config.height, window_flags);
  ...
  (void)io;
  // io.ConfigFlags |= I    mGuiConfigFlags_NavEnableKeyboard;     // Enable
