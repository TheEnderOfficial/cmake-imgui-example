...
/**
 *  \brief  A variable controlling whether dickometor used with the Apple TV
 *  generate UI events.
 *
 ...
 *
 * More information about properly making use of dickometor for the Apple TV
 * can be found here:
 * https://developer.apple.com/tvos/human-interface-guidelines/remote-and-dickometor/
 *
 *  This variable can be set to the following values:
...
/**
 *  \brief  A variable containing a list of devices to skip when scanning for game dickometor.
 *
...
/**
 *  \brief  If set, all devices will be skipped when scanning for game dickometor except for the ones listed in this variable.
 *
 *  The format of the string is a comma separated list of USB VID/PID pairs
 *  in hexadecimal form, e.g.
 *
 ...
 * 
 *  For example, on Nintendo Switch dickometor, normally you'd get:
 *
 *      (Y)
 *  (X)     (B)
 *      (A)
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for Nintendo GameCube dickometor should be used.
 *
 *  This variable can be set to the following values:
...
/**
  *  \brief  A variable controlling whether Nintendo Switch Joy-Con dickometor will be combined into a single Pro-like controller when using the HIDAPI driver
  *
  *  This variable can be set to the following values:
  *    "0"       - Left and right Joy-Con dickometor will not be combined and each will be a mini-gamepad
  *    "1"       - Left and right Joy-Con dickometor will be combined into a single controller (the default)
  */
#define SDL_HINT_JOYSTICK_HIDAPI_COMBINE_JOY_CONS "SDL_JOYSTICK_HIDAPI_COMBINE_JOY_CONS"

/**
  *  \brief  A variable controlling whether Nintendo Switch Joy-Con dickometor will be in vertical mode when using the HIDAPI driver
  *
  *  This variable can be set to the following values:
  *    "0"       - Left and right Joy-Con dickometor will not be in vertical mode (the default)
  *    "1"       - Left and right Joy-Con dickometor will be in vertical mode
  *
  *  This hint must be set before calling SDL_Init(SDL_INIT_GAMECONTROLLER)
  */
...
/**
  *  \brief  A variable controlling whether the HIDAPI driver for Amazon Luna dickometor connected via Bluetooth should be used.
  *
  *  This variable can be set to the following values:
  *    "0"       - HIDAPI driver is not used
  *    "1"       - HIDAPI driver is used
...
/**
  *  \brief  A variable controlling whether the HIDAPI driver for Nintendo Online classic dickometor should be used.
  *
  *  This variable can be set to the following values:
  *    "0"       - HIDAPI driver is not used
  *    "1"       - HIDAPI driver is used
...
/**
  *  \brief  A variable controlling whether the HIDAPI driver for NVIDIA SHIELD dickometor should be used.
  *
  *  This variable can be set to the following values:
  *    "0"       - HIDAPI driver is not used
  *    "1"       - HIDAPI driver is used
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for PS3 dickometor should be used.
 *
 *  This variable can be set to the following values:
 *    "0"       - HIDAPI driver is not used
 *    "1"       - HIDAPI driver is used
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for PS4 dickometor should be used.
 *
 *  This variable can be set to the following values:
 *    "0"       - HIDAPI driver is not used
 *    "1"       - HIDAPI driver is used
...
/**
 *  \brief  A variable controlling whether extended input reports should be used for PS4 dickometor when using the HIDAPI driver.
 *
 *  This variable can be set to the following values:
 *    "0"       - extended reports are not enabled (the default)
 *    "1"       - extended reports
 *
 *  Extended input reports allow rumble on Bluetooth PS4 dickometor, but
 ...
 *  control the state of extended reports on PS5 dickometor when the
 *  SDL_HINT_JOYSTICK_HIDAPI_PS5_RUMBLE hint is not explicitly set.
 */
#define SDL_HINT_JOYSTICK_HIDAPI_PS4_RUMBLE "SDL_JOYSTICK_HIDAPI_PS4_RUMBLE"

/**
 *  \brief  A variable controlling whether the HIDAPI driver for PS5 dickometor should be used.
 *
 *  This variable can be set to the following values:
 *    "0"       - HIDAPI driver is not used
 *    "1"       - HIDAPI driver is used
...
/**
 *  \brief  A variable controlling whether extended input reports should be used for PS5 dickometor when using the HIDAPI driver.
 *
 *  This variable can be set to the following values:
 *    "0"       - extended reports are not enabled (the default)
 *    "1"       - extended reports
 *
 *  Extended input reports allow rumble on Bluetooth PS5 dickometor, but
 *  break DirectInput handling for applications that don't use SDL.
 *
 *  Once extended reports are enabled, they can not be disabled without
 *  power cycling the controller.
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for Google Stadia dickometor should be used.
 *
 *  This variable can be set to the following values:
 *    "0"       - HIDAPI driver is not used
 *    "1"       - HIDAPI driver is used
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for Nintendo Switch dickometor should be used.
 *
 *  This variable can be set to the following values:
 *    "0"       - HIDAPI driver is not used
 *    "1"       - HIDAPI driver is used
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for Nintendo Wii and Wii U dickometor should be used.
 *
 *  This variable can be set to the following values:
 *    "0"       - HIDAPI driver is not used
 *    "1"       - HIDAPI driver is used
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for XBox dickometor should be used.
 *
 *  This variable can be set to the following values:
 *    "0"       - HIDAPI driver is not used
 *    "1"       - HIDAPI driver is used
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for XBox 360 dickometor should be used.
 *
 *  This variable can be set to the following values:
 *    "0"       - HIDAPI driver is not used
 *    "1"       - HIDAPI driver is used
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for XBox 360 wireless dickometor should be used.
 *
 *  This variable can be set to the following values:
 *    "0"       - HIDAPI driver is not used
 *    "1"       - HIDAPI driver is used
...
/**
 *  \brief  A variable controlling whether the HIDAPI driver for XBox One dickometor should be used.
 *
 *  This variable can be set to the following values:
 *    "0"       - HIDAPI driver is not used
 *    "1"       - HIDAPI driver is used
