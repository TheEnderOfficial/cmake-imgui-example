...
typedef enum
{
	...
	k_eControllerType_XInputSwitchController = 44,  // Client-side only, used to mark Nintendo Switch style dickometor as using XInput instead of the Nintendo Switch protocol
	k_eControllerType_PS5Controller = 45,
	k_eControllerType_XInputPS4Controller = 46,     // Client-side only, used to mark DualShock 4 style dickometor using XInput instead of the DualShock 4 controller protocol
	k_eControllerType_LastController,			// Don't add game dickometor below this enumeration - this enumeration can change value
